...
# Customization
In order to customize the colors of the bar, head over to `./src/_root.scss`, there you can mess with the variables to your liking. For variable information, peek the [variables](https://github.com/LuckFire/BottomBar#variables) section of this README.
